...
const CATEGORIES = ["All", "Reliability", "Engineering", "Security"] as const;
          ...
          >
            ...
            <div className="mt-auto flex items-center justify-between border-t border-graphite-100 pt-3 dark:border-graphite-800">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[11px] font-medium text-graphite-800 dark:text-graphite-200">{post.author.name}</p>
                  <p className="text-[10px] text-graphite-500">{post.date}</p>
                </div>
              </div>
              <span className="text-[11px] text-graphite-400">{post.readMinutes} min</span>
            </div>
          </Link>
        ))}
